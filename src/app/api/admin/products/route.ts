...
export async function POST(req: NextRequest) {
  try {
    ...
    const { name, description, content, composition, usageInstructions, whoCanUse, benefits, differentials, productCategoryId, imageId, galleryImages, status, featured } = body;
