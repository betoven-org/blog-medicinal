...
/**
 * @title Post Destaque
 * @description Hero principal estilo UOL — post em destaque + lista lateral de posts recentes
 * @group Home
 */
        ...
        <div className="lg:grid lg:grid-cols-3 lg:gap-6">
          ...
          <div className="lg:col-span-2">
            <a
              ...
              aria-label={`Ler post: ${featured.title}`}
            ...
            >
              {featuredImageUrl ? (
                ...
                <div
                  className="w-full aspect-[16/10] rounded-lg bg-[#0d61ac]"
                  aria-hidden="true"
                />
              )}
            </a>
                    ...
                    >
                      ...
                      >
                        {sideImageUrl ? (
                          ...
                          <div
                            className="w-20 h-20 rounded-lg bg-[#0d61ac] flex-shrink-0"
                            aria-hidden="true"
                          />
                        )}
